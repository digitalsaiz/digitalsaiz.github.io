...
const T = {
  en: {
    ...
    // hero
    'hero.badge':    '✦ Powered by AI · Built for Care & Therapy Providers',
    ...
    'who.title': 'Built for Every Care & Therapy Service Provider',
    ...
    'feat.f10.h':  'Custom Questionnaires',
    'feat.f10.p':  'Design your own session form. Clone any built-in template and edit anything — sections, questions, options, and conditional "show only when" logic. Premium.',
    'feat.f11.h':  'AI Questionnaire Builder',
    'feat.f11.p':  'Paste a sample note or template and AI generates a complete questionnaire matched to your service. Refine with suggestions, then approve when it\'s right. Premium.',
    'feat.f12.h':  'Share with Your Team',
    'feat.f12.p':  'Send any custom questionnaire to a teammate with a tap-to-import link. They get their own editable copy in seconds — same forms across your whole team. Premium.',
    ...
    // builder spotlight (Premium custom questionnaires)
    'bdr.tag':         '⭐ Premium',
    'bdr.title':       'Make the Form Fit Your Practice',
    'bdr.sub':         "Don't fit your work to the app. Tailor the session form to capture exactly what your service requires — by hand, with AI, or starting from any built-in template.",
    'bdr.s1.h':        'Clone & customize',
    'bdr.s1.p':        'Start from any service-specific template and edit everything — section titles, question types, options, even conditional "show only when" logic.',
    'bdr.s2.h':        'Or let AI build it',
    'bdr.s2.p':        "Paste a sample note and the AI Questionnaire Builder generates a complete form for your service. Refine with suggestions, approve when it's right.",
    'bdr.s3.h':        'Share with your team',
    'bdr.s3.p':        'Send any custom questionnaire to a teammate via tap-to-import link. Same forms across your whole team — no copy-paste.',
    'bdr.mockup.title':  '📝 My ABA Template',
    'bdr.mockup.aiTitle':'AI Questionnaire Builder',
    'bdr.mockup.aiSub':  'Paste a note — AI builds the form for you',
    'bdr.mockup.section':'Activities Provided',
    'bdr.mockup.q1':     'Which services were delivered today?',
    'bdr.mockup.q2':     'Any behavioral concerns observed?',
    'bdr.mockup.q3':     'Describe the behavior',
    'bdr.mockup.cond':   'Shows only if Yes',
    ...
    'pr.p.badge': '⭐ Premium',
    'pr.p.h':    'Cloud + Custom',
    'pr.p.desc': 'Everything in AI Note Generation, plus cloud sync and the full custom-questionnaire toolkit.',
    ...
    'pr.p.f6':   'Custom questionnaires per service',
    'pr.p.f7':   'AI Questionnaire Builder',
    'pr.p.f8':   'Share questionnaires with your team',
    ...
    'prv.c4.p':  'Notes are formatted to professional documentation standards. You are responsible for final compliance review against your local regulations.',

    // cta banner
    'cta.h':   'Spend Less Time on Paperwork.<br />More Time on Care.',
    'cta.p':   'Join providers who use Note TCA to generate professional session notes in seconds — not hours.',
  ...
  es: {
    ...
    'hero.badge':    '✦ Impulsado por IA · Para Proveedores de Cuidado y Terapia',
    ...
    'who.tag':   'Para Quién',
    'who.title': 'Para Cada Proveedor de Servicios de Cuidado y Terapia',
    ...
    'feat.f10.h':  'Cuestionarios Personalizados',
    'feat.f10.p':  'Diseña tu propio formulario de sesión. Clona cualquier plantilla incorporada y edita lo que quieras — secciones, preguntas, opciones y lógica condicional "mostrar solo cuando". Premium.',
    'feat.f11.h':  'Constructor de Cuestionarios con IA',
    'feat.f11.p':  'Pega una nota o plantilla y la IA genera un cuestionario completo adaptado a tu servicio. Refínalo con sugerencias y apruébalo cuando esté listo. Premium.',
    'feat.f12.h':  'Comparte con tu Equipo',
    'feat.f12.p':  'Envía cualquier cuestionario personalizado a un compañero con un enlace de un solo toque. Obtiene su propia copia editable en segundos — los mismos formularios en todo el equipo. Premium.',
    ...
    'bdr.tag':         '⭐ Premium',
    'bdr.title':       'Haz que el Formulario se Ajuste a tu Práctica',
    'bdr.sub':         'No adaptes tu trabajo a la app. Personaliza el formulario de sesión para capturar exactamente lo que tu servicio necesita — a mano, con IA, o partiendo de cualquier plantilla incorporada.',
    'bdr.s1.h':        'Clona y personaliza',
    'bdr.s1.p':        'Parte de cualquier plantilla específica del servicio y edita todo — títulos de sección, tipos de pregunta, opciones, incluso lógica condicional de "mostrar solo cuando".',
    'bdr.s2.h':        'O deja que la IA lo construya',
    'bdr.s2.p':        'Pega una nota de muestra y el Constructor de Cuestionarios con IA genera un formulario completo para tu servicio. Refínalo con sugerencias y apruébalo cuando esté listo.',
    'bdr.s3.h':        'Comparte con tu equipo',
    'bdr.s3.p':        'Envía cualquier cuestionario personalizado a un compañero con un enlace de un solo toque. Los mismos formularios en todo el equipo — sin copiar y pegar.',
    'bdr.mockup.title':  '📝 Mi Plantilla ABA',
    'bdr.mockup.aiTitle':'Constructor de Cuestionarios con IA',
    'bdr.mockup.aiSub':  'Pega una nota — la IA construye el formulario',
    'bdr.mockup.section':'Actividades Realizadas',
    'bdr.mockup.q1':     '¿Qué servicios se brindaron hoy?',
    'bdr.mockup.q2':     '¿Se observaron inquietudes conductuales?',
    'bdr.mockup.q3':     'Describe la conducta',
    'bdr.mockup.cond':   'Se muestra solo si es Sí',
    ...
    'pr.p.badge': '⭐ Premium',
    'pr.p.h':    'Nube + Personalización',
    'pr.p.desc': 'Todo lo de Generación de Notas con IA, más sincronización en la nube y el kit completo de cuestionarios personalizados.',
    'pr.p.f1':   'Todo lo de Generación de Notas con IA',
    'pr.p.f2':   'Guarda y accede a notas desde cualquier dispositivo',
    'pr.p.f3':   'Perfiles ilimitados de clientes y proveedores',
    'pr.p.f4':   'Conjuntos de servicio para crear notas con 1 toque',
    'pr.p.f5':   'Historial completo de notas con búsqueda',
    'pr.p.f6':   'Cuestionarios personalizados por servicio',
    'pr.p.f7':   'Constructor de Cuestionarios con IA',
    'pr.p.f8':   'Comparte cuestionarios con tu equipo',
    ...
    'prv.c4.p':  'Las notas están formateadas según estándares profesionales de documentación. Tú eres responsable de la revisión final de cumplimiento conforme a tus regulaciones locales.',

    'cta.h':   'Menos Tiempo en Papeleo.<br />Más Tiempo en el Cuidado.',
    'cta.p':   'Únete a los proveedores que usan Note TCA para generar notas de sesión profesionales en segundos, no en horas.',
  ...
  ht: {
    ...
    'hero.badge':    '✦ Teknoloji IA · Bati pou Founisè Swen ak Terapi',
    ...
    'who.tag':   'Pou Kiyès',
    'who.title': 'Bati pou Tout Founisè Sèvis Swen ak Terapi',
    ...
    'feat.f10.h':  'Kesyonè Pèsonalize',
    'feat.f10.p':  'Konsevwa pwòp fòm sesyon ou. Klone nenpòt modèl entegre epi modifye tout sa ou vle — seksyon, kesyon, opsyon, ak lojik kondisyonèl "montre sèlman lè". Premium.',
    'feat.f11.h':  'Konstriktè Kesyonè ak IA',
    'feat.f11.p':  'Kole yon nòt egzanp oswa yon modèl epi IA jenere yon kesyonè konplè adapte ak sèvis ou. Rafine ak sijesyon, epi apwouve lè li bon. Premium.',
    'feat.f12.h':  'Pataje ak Ekip Ou',
    'feat.f12.p':  'Voye nenpòt kesyonè pèsonalize bay yon kòlèg ak yon lyen pou enpòte. Yo jwenn pwòp kopi modifyab yo nan kèk segond — menm fòm yo nan tout ekip ou. Premium.',
    ...
    'bdr.tag':         '⭐ Premium',
    'bdr.title':       'Fè Fòm nan Adapte ak Pratik Ou',
    'bdr.sub':         "Pa adapte travay ou ak aplikasyon an. Adapte fòm sesyon an pou kaptire egzakteman sa sèvis ou bezwen — manyèlman, ak IA, oswa kòmanse soti nan nenpòt modèl entegre.",
    'bdr.s1.h':        'Klone ak pèsonalize',
    'bdr.s1.p':        'Kòmanse soti nan nenpòt modèl espesifik pou sèvis epi modifye tout bagay — tit seksyon, tip kesyon, opsyon, menm lojik kondisyonèl "montre sèlman lè".',
    'bdr.s2.h':        'Oswa kite IA bati l',
    'bdr.s2.p':        "Kole yon nòt egzanp epi Konstriktè Kesyonè ak IA jenere yon fòm konplè pou sèvis ou. Rafine ak sijesyon, apwouve lè li bon.",
    'bdr.s3.h':        'Pataje ak ekip ou',
    'bdr.s3.p':        'Voye nenpòt kesyonè pèsonalize bay yon kòlèg ak yon lyen pou enpòte. Menm fòm nan tout ekip ou — pa gen kopi-kole.',
    'bdr.mockup.title':  '📝 Modèl ABA Mwen',
    'bdr.mockup.aiTitle':'Konstriktè Kesyonè ak IA',
    'bdr.mockup.aiSub':  'Kole yon nòt — IA bati fòm nan pou ou',
    'bdr.mockup.section':'Aktivite ki Fèt',
    'bdr.mockup.q1':     'Ki sèvis yo te bay jodi a?',
    'bdr.mockup.q2':     'Èske te gen pwoblèm konpòtman?',
    'bdr.mockup.q3':     'Dekri konpòtman an',
    'bdr.mockup.cond':   'Parèt sèlman si Wi',
    ...
    'pr.p.badge': '⭐ Premium',
    'pr.p.h':    'Nwaj + Pèsonalize',
    'pr.p.desc': 'Tout nan Jenerasyon Nòt ak IA, plis senkronizasyon nwaj ak twous konplè pou kesyonè pèsonalize.',
    ...
    'pr.p.f6':   'Kesyonè pèsonalize pa sèvis',
    'pr.p.f7':   'Konstriktè Kesyonè ak IA',
    'pr.p.f8':   'Pataje kesyonè ak ekip ou',
    ...
    'prv.c4.p':  'Nòt yo fòmante selon estanda dokimantasyon pwofesyonèl. Ou responsab pou revizyon konfòmite final la dapre règleman lokal ou yo.',
